...
public class ShowResult : MonoBehaviour {
	...
	void Start () {
		...
		int scoreDigitalCnt = Utils.GetDigitNumber(Global.curScore);
		...
		comboLabel.SetNumber(Global.curMaxCombo);
		int comboDigitalCnt = Utils.GetDigitNumber(Global.curMaxCombo);
	...
	void Update () {
		if (Utils.IsOnTouch_ByRect(backButtonRect, Input.touches))
		{
